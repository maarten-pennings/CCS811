...
class CCS811 {
  ...
  public: // Extra interface
    ...
    bool set_envdataDHT(int temperature, int relativeHumidity);              // Writes temperature and relativeHumidity (with temperature in C and humidity as percent) to ENV_DATA . Returns false on I2C problems.
